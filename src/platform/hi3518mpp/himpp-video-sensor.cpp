...
static ISP_IMAGE_ATTR_S galaxycore_gc1014_image_attr = {
    .u16Width           = 1280,
    .u16Height          = 720,
    .u16FrameRate       = 30,
    .enBayer            = BAYER_RGGB
...
static ISP_INPUT_TIMING_S galaxycore_gc1014_input_timing = {
    .enWndMode          = ISP_WIND_NONE,
    .u16HorWndStart     = 0,
    .u16HorWndLength    = 1280,
    .u16VerWndStart     = 0,
...
static VI_DEV_ATTR_S galaxycore_gc1014_dev_attr = {
    .enIntfMode     = VI_MODE_DIGITAL_CAMERA,
    .enWorkMode     = VI_WORK_MODE_1Multiplex,
    .au32CompMask   = { 0xFFC00000, 0x0 },
    .enScanMode     = VI_SCAN_PROGRESSIVE,
...
static HIMPP_SENSOR_CONFIG galaxycore_gc1014_sensor_config = {
    .name               = "gc1014",
    .module_path        = "libsns_gc1014.so",
    .isp_image_attr     = &galaxycore_gc1014_image_attr,
    .isp_input_timing   = &galaxycore_gc1014_input_timing,
    .vi_dev_attr        = &galaxycore_gc1014_dev_attr
};
...
#define addSensor(sensor) himpp_video_sensor_map.emplace(sensor.name, &sensor)
        ...
        addSensor(galaxycore_gc1014_sensor_config);

...
HimppVideoOSD::HimppVideoOSD(Hi3518mppMedia &media, HimppVencChan &venc_chan, uint32_t id)
...
RGN_HANDLE Hi3518mppMedia::allocRegionHandle()
{
...
void Hi3518mppMedia::freeRegionHandle(RGN_HANDLE handle)
{
